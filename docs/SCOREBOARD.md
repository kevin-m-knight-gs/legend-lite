> ## ⚠ STALE APPEND-LOG — banner added 2026-08-06
>
> A historical append-log. Its generator, `tools/scoreboard.py`, is invoked by
> nothing — no gate, no script, no CI step — so this file has not tracked
> reality for some time.
>
> **The live scoreboards are** `docs/RELATIONAL_CORPUS.md` (regenerated by
> gate 4) and `docs/RELATIONAL_CORPUS_ALL.md` (100% mode). See `docs/GATES.md`.
...
### Run 2026-07-10 @ 28ba503

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2278** | 60 | 364 | 19 | 305 |

| bucket | exception lines |
|---|---|
| OTHER | 142 |
| CORE: unlowered constructs | 63 |
| FIXTURE: unknown refs (to diagnose) | 61 |
| CORE: scalar/agg function registrations | 22 |
| CORE(parse): query syntax gaps | 11 |
| CORE(G): overload/typing gaps | 6 |
...
### Run 2026-07-10 @ 5c34e56

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2333** | 60 | 309 | 19 | 318 |
...
### Run 2026-07-10 @ cd5d580

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2359** | 60 | 283 | 19 | 322 |
...
### Run 2026-07-10 @ bc24d15

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2372** | 60 | 270 | 19 | 322 |

| bucket | exception lines |
|---|---|
| OTHER | 143 |
| CORE: unlowered constructs | 50 |
| CORE: scalar/agg function registrations | 22 |
| CORE(parse): query syntax gaps | 11 |
| CORE(G): overload/typing gaps | 6 |
| FIXTURE: unknown refs (to diagnose) | 5 |
...
### Run 2026-07-10 @ cfefae2

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2416** | 66 | 220 | 19 | 325 |

| bucket | exception lines |
|---|---|
| OTHER | 104 |
| CORE: unlowered constructs | 31 |
| CORE: scalar/agg function registrations | 22 |
| CORE(parse): query syntax gaps | 15 |
| CORE(G): overload/typing gaps | 6 |
| FIXTURE: unknown refs (to diagnose) | 5 |
...
```
   ...
   10  scalar lowering not yet implemented for TypedFilter
    ...
    2  in function 'model::M$class$model::R': expected a zero-parameter singl
    2  aggregate 'wa' composes multiple reducers (wavg) — not usable in windo
```

### Run 2026-07-10 @ 7b6edc5

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2420** | 67 | 215 | 19 | 325 |
...
```
   ...
   10  scalar lowering not yet implemented for TypedFilter
    ...
    2  in function 'model::M$class$model::R': expected a zero-parameter singl
    2  aggregate 'wa' composes multiple reducers (wavg) — not usable in windo
    2  in call to 'meta::pure::functions::collection::add', argument 2: expec
```

### Run 2026-07-10 @ 9afca92

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2433** | 59 | 210 | 19 | 327 |

| bucket | exception lines |
|---|---|
| OTHER | 102 |
| CORE: unlowered constructs | 27 |
| CORE: scalar/agg function registrations | 22 |
| CORE(parse): query syntax gaps | 11 |
| CORE(G): overload/typing gaps | 6 |
| FIXTURE: unknown refs (to diagnose) | 5 |
...
### Run 2026-07-10 @ 7cb6c14

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2447** | 56 | 199 | 19 | 330 |

| bucket | exception lines |
|---|---|
| OTHER | 99 |
| CORE: unlowered constructs | 27 |
| CORE: scalar/agg function registrations | 21 |
| CORE(parse): query syntax gaps | 9 |
| CORE(G): overload/typing gaps | 6 |
| FIXTURE: unknown refs (to diagnose) | 5 |
...
### Run 2026-07-10 @ 1a4b5d9

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2448** | 56 | 198 | 19 | 330 |
...
### Run 2026-07-10 @ ff7a3ba

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2460** | 56 | 186 | 19 | 333 |
...
```
   ...
   10  scalar lowering not yet implemented for TypedFilter
    ...
    2  flatten source column 'items' cannot be resolved (unresolvable project
    2  graph child 'address' of class 'model::PersonWithAddress' is mapped as
    2  class query under TypedCast is not resolvable yet (H2 vocabulary)
```

### Run 2026-07-10 @ c8aab9b

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2486** | 56 | 160 | 19 | 339 |
...
```
   11  no scalar lowering registered for resolved overload 'meta::pure::funct
    ...
    1  in function 'model::M$class$model::R': unknown function 'group'
    1  in function 'model::M$class$model::P': unknown function 'isNotNull'
```

### Run 2026-07-10 @ 39fa320
...
### Run 2026-07-10 @ 65f8b01

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2505** | 45 | 152 | 19 | 343 |

| bucket | exception lines |
|---|---|
| OTHER | 85 |
| CORE: scalar/agg function registrations | 18 |
| CORE(G): overload/typing gaps | 6 |
| CORE(parse): query syntax gaps | 6 |
| FIXTURE: unknown refs (to diagnose) | 5 |
| CORE: unlowered constructs | 2 |
...
### Run 2026-07-10 @ 1420325

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2514** | 39 | 149 | 19 | 344 |

| bucket | exception lines |
|---|---|
| OTHER | 85 |
| CORE: scalar/agg function registrations | 17 |
| CORE(G): overload/typing gaps | 6 |
| CORE(parse): query syntax gaps | 6 |
| FIXTURE: unknown refs (to diagnose) | 5 |
| CORE: unlowered constructs | 2 |
...
Top detail:
```
   10  no scalar lowering registered for resolved overload 'meta::pure::funct
    9  unknown SQL data type: 'JSON'
    6  multi-column pivot is not lowered yet
    6  no TDS cell rendering for Pure type meta::pure::metamodel::variant::Va
    6  model-to-model binding of 'model::StaffComplete' in 'model::DisjointDe
...
### Run 2026-07-10 @ 0e8d370

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2519** | 39 | 144 | 19 | 344 |
...
### Run 2026-07-10 @ b58a4b7

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2525** | 39 | 138 | 19 | 347 |
...
### Run 2026-07-10 @ e29a4ef

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2532** | 37 | 133 | 19 | 347 |
...
| CORE: scalar/agg function registrations | 12 |
| CORE(G): overload/typing gaps | 6 |
| CORE(parse): query syntax gaps | 5 |
| FIXTURE: unknown refs (to diagnose) | 5 |
| CORE: unlowered constructs | 2 |
...
### Run 2026-07-10 @ 0e463e9

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2544** | 37 | 121 | 19 | 351 |
...
### Run 2026-07-11 @ cd6f277

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2553** | 37 | 112 | 19 | 351 |
...
```
   11  no scalar lowering registered for resolved overload 'meta::pure::funct
    ...
    1  graph child 'address' of class 'model::ActivePersonWithAddress' is map
    1  ~[] is empty: a column-specification array needs columns
    1  type 'VARCHAR' requires arguments; use its record constructor
    1  MappingDefinition 'test::M' contains multiple ClassMappings for class 
```

### Run 2026-07-11 @ 049f8ae

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2565** | 37 | 100 | 19 | 351 |
...
```
    ...
    1  type 'VARCHAR' requires arguments; use its record constructor
    1  MappingDefinition 'test::M' contains multiple ClassMappings for class 
    1  [12:21] No ~mainTable for class 'test::Price' in mapping=test::M (requ
```

### Run 2026-07-11 @ 834a01d

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2584** | 35 | 83 | 19 | 352 |
...
```
    ...
    1  MappingDefinition 'test::M' contains multiple ClassMappings for class 
    1  [12:21] No ~mainTable for class 'test::Price' in mapping=test::M (requ
    1  in function 'test::M$class$test::Employee': unknown table 'hr.EMPLOYEE
```

### Run 2026-07-11 @ 4923de5

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2592** | 35 | 75 | 19 | 357 |
...
```
    ...
    1  [12:21] No ~mainTable for class 'test::Price' in mapping=test::M (requ
    1  in function 'test::M$class$test::Employee': unknown table 'hr.EMPLOYEE
    1  in function 'test::M$class$test::Person': unknown table 'BASE_PERSON' 
    1  in function 'test::M$class$test::Order': no overload of 'meta::pure::f
```

### Run 2026-07-11 @ 2ae195f

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2599** | 34 | 69 | 19 | 359 |
...
```
    ...
    1  in function 'test::M$class$test::Person': unknown table 'BASE_PERSON' 
    1  in function 'test::M$class$test::Order': no overload of 'meta::pure::f
    1  PM 'region' is a per-row expression that is neither an aggregate nor a
```

### Run 2026-07-11 @ 1a91e77

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2605** | 34 | 63 | 19 | 363 |
...
### Run 2026-07-11 @ 43dd2d9

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2612** | 33 | 57 | 19 | 364 |

| bucket | exception lines |
|---|---|
| OTHER | 42 |
| CORE(parse): query syntax gaps | 6 |
| FIXTURE: unknown refs (to diagnose) | 3 |
| CORE: unlowered constructs | 2 |
| CORE(G): overload/typing gaps | 2 |
...
```
    ...
    1  ~[] is empty: a column-specification array needs columns
    1  type 'VARCHAR' requires arguments; use its record constructor
    1  'meta::pure::functions::boolean::eq_Any_1__Any_1__Boolean_1_' is not a
    1  SQL dialect for database type 'H2' (connection 'store::Conn' of runtim
    1  Out of Range Error: Overflow in multiplication of INT64 (2 * 922337203
    1  in call to 'meta::pure::functions::math::corr', argument 2: expected N
    1  Out of Range Error: Overflow in subtraction of INT64 (-922337203685477
    1  in call to 'meta::pure::functions::string::splitPart', argument 1: exp
```

### Run 2026-07-11 @ 3d467bf

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2617** | 30 | 55 | 19 | 366 |
...
| CORE: unlowered constructs | 2 |
| CORE(G): overload/typing gaps | 2 |
| FIXTURE: unknown refs (to diagnose) | 2 |
...
### Run 2026-07-11 @ 2784dc2

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2625** | 24 | 53 | 19 | 371 |
...
```
    ...
    1  Out of Range Error: Overflow in subtraction of INT64 (-922337203685477
    1  in call to 'meta::pure::functions::string::splitPart', argument 1: exp
    1  Out of Range Error: Left-shift value 46 is out of range
```

### Run 2026-07-11 @ e89141f

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2630** | 21 | 51 | 19 | 373 |
...
### Run 2026-07-11 @ e14d32d

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2637** | 20 | 45 | 19 | 377 |
...
| CORE(G): overload/typing gaps | 2 |
| FIXTURE: unknown refs (to diagnose) | 2 |
| CORE(parse): query syntax gaps | 2 |
...
### Run 2026-07-11 @ 61b75cd

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2648** | 15 | 39 | 19 | 377 |
...
### Run 2026-07-11 @ 56afa04

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2652** | 13 | 37 | 19 | 377 |
...
### Run 2026-07-11 @ cdcf6ef

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2661** | 9 | 32 | 19 | 381 |
...
### Run 2026-07-11 @ 8ec20ed

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2668** | 6 | 28 | 19 | 386 |
...
### Run 2026-07-11 @ e169102

| tests | pass | failures | errors | skipped | green classes |
|---|---|---|---|---|---|
| 2721 | **2670** | 6 | 26 | 19 | 387 |
