...
| 5 | PCT full (DuckDB) | `cd pct && mvn test` | green (1 ledgered Relation expected-failure) |
| 6 | PCT h2 Relation guard | `cd pct && LEGENDLITE_PCT_BACKEND=h2 mvn test -Dtest=Test_LegendLite_RelationFunctions_PCT` | 313/348 |
| 7 | PCT h2modern guard | as #6 plus `-Dh2.version=2.4.240` | 325/348 |

Gates 5–7 are required whenever core is touched; 6–7 whenever a
