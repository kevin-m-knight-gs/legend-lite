...
if want 8; then
  ...
  mvn ${SFLAG[@]+"${SFLAG[@]}"} -pl parser-equivalence -am test \
      -Dtest='CorpusEquivalenceTest,RejectionParityTest,SpiSeamProofTest,SectionParseSentinelTest,FixtureAdjudicationTest,EngineSectionRosterTest,EngineElementRosterTest,PmcdEquivalenceTest,ViewFilterParityTest,LeniencyCatalogTest,StrictDialectParityTest,ComparatorSelfTest,CorpusManifestTest,RefusalSymmetryTest,QuotedImportParityTest' \
