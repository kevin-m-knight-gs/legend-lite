...
public enum DynaFn {
    ...
    IS_ALPHA_NUMERIC("isAlphaNumeric", Resolution.PURE, null, Inference.NONE, Dialect.DATABRICKS, Dialect.DUCKDB, Dialect.H2, Dialect.SNOWFLAKE, Dialect.SPARKSQL, Dialect.SYBASE, Dialect.SYBASEIQ),
