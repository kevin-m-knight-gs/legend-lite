...
public enum DynaFn {
    ...
    ARRAY_APPEND("array_append", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_CONCATENATE("array_concatenate", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_CONTAINS("array_contains", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_DISTINCT("array_distinct", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_DROP("array_drop", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_FIRST("array_first", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_FLATTEN("array_flatten", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_INIT("array_init", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_LAST("array_last", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_MAX("array_max", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.CLICKHOUSE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_MIN("array_min", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.CLICKHOUSE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_POSITION("array_position", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_REVERSE("array_reverse", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_SIZE("array_size", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_SLICE("array_slice", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_SORT("array_sort", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_SUM("array_sum", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_TAIL("array_tail", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_TAKE("array_take", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ARRAY_TO_STRING("array_to_string", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ...
    BIT_AND("bitAnd", Resolution.PURE, null, Inference.MAPPED, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    BIT_NOT("bitNot", Resolution.PURE, null, Inference.MAPPED, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    BIT_OR("bitOr", Resolution.PURE, null, Inference.MAPPED, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    BIT_SHIFT_LEFT("bitShiftLeft", Resolution.PURE, null, Inference.MAPPED, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    BIT_SHIFT_RIGHT("bitShiftRight", Resolution.PURE, null, Inference.MAPPED, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    BIT_XOR("bitXor", Resolution.PURE, null, Inference.MAPPED, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ...
    DATE("date", Resolution.PURE, null, Inference.NONE, Dialect.CLICKHOUSE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ...
    GENERATE_GUID("generateGuid", Resolution.PURE, null, Inference.NONE, Dialect.CLICKHOUSE, Dialect.DUCKDB, Dialect.H2, Dialect.MEMSQL, Dialect.POSTGRES, Dialect.SNOWFLAKE, Dialect.SQLSERVER, Dialect.SYBASE, Dialect.SYBASEIQ),
    ...
    IS_EMPTY("isEmpty", Resolution.PURE, null, Inference.MAPPED, Dialect.DEFAULT, Dialect.ORACLE, Dialect.SPARKSQL, Dialect.SYBASE, Dialect.SYBASEIQ),
    IS_NOT_EMPTY("isNotEmpty", Resolution.PURE, null, Inference.MAPPED, Dialect.DEFAULT, Dialect.ORACLE, Dialect.SPANNER, Dialect.SPARKSQL, Dialect.SYBASE, Dialect.SYBASEIQ),
    IS_NOT_NULL("isNotNull", Resolution.TRANSLATED, null, Inference.MAPPED, Dialect.DEFAULT, Dialect.ORACLE, Dialect.SPARKSQL, Dialect.SYBASE, Dialect.SYBASEIQ),
    IS_NULL("isNull", Resolution.TRANSLATED, null, Inference.MAPPED, Dialect.DEFAULT, Dialect.ORACLE, Dialect.SPANNER, Dialect.SPARKSQL, Dialect.SYBASE, Dialect.SYBASEIQ),
    ...
    KEYS("keys", Resolution.PURE, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ...
    LEVENSHTEIN_DISTANCE("levenshteinDistance", Resolution.PURE, null, Inference.MAPPED, Dialect.CLICKHOUSE, Dialect.DUCKDB, Dialect.H2, Dialect.SNOWFLAKE),
    ...
    MAP_CONCATENATE("mapConcatenate", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    MATCHES("matches", Resolution.PURE, null, Inference.NONE, Dialect.CLICKHOUSE, Dialect.DATABRICKS, Dialect.DUCKDB, Dialect.H2, Dialect.MEMSQL, Dialect.ORACLE, Dialect.POSTGRES, Dialect.PRESTO, Dialect.SNOWFLAKE, Dialect.SPARKSQL, Dialect.SYBASE, Dialect.SYBASEIQ, Dialect.TRINO),
    ...
    PARSE_BOOLEAN("parseBoolean", Resolution.PURE, null, Inference.NONE, Dialect.CLICKHOUSE, Dialect.SNOWFLAKE),
    ...
    RANGE("range", Resolution.PURE, null, Inference.NONE, Dialect.CLICKHOUSE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    RANK("rank", Resolution.PURE, null, Inference.MAPPED, Dialect.DEFAULT),
    REGEXP_COUNT("regexpCount", Resolution.PURE, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    REGEXP_EXTRACT("regexpExtract", Resolution.PURE, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    REGEXP_INDEX_OF("regexpIndexOf", Resolution.PURE, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    REGEXP_LIKE("regexpLike", Resolution.PURE, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    REGEXP_REPLACE("regexpReplace", Resolution.PURE, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
    ...
    TO_VARIANT("toVariant", Resolution.PURE, null, Inference.MAPPED, Dialect.DUCKDB, Dialect.POSTGRES, Dialect.SNOWFLAKE),
    TO_VARIANT_LIST("toVariantList", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.CLICKHOUSE, Dialect.DUCKDB, Dialect.POSTGRES, Dialect.SNOWFLAKE),
    TO_VARIANT_OBJECT("toVariantObject", Resolution.UNSUPPORTED, null, Inference.NONE, Dialect.DUCKDB, Dialect.POSTGRES, Dialect.SNOWFLAKE),
    ...
    VALUES("values", Resolution.PURE, null, Inference.NONE, Dialect.DUCKDB, Dialect.SNOWFLAKE),
