...
public final class Pure {
    ...
    public static final NativeFunctionDefinition SCAN_RELATIONS__3 = signature("native function meta::pure::lineage::scanRelations::scanRelations(f:meta::pure::metamodel::function::Function<{->meta::pure::metamodel::type::Any[*]}>[1], m:meta::pure::metamodel::type::Any[1], extensions:meta::pure::metamodel::type::Any[*]):meta::pure::lineage::scanRelations::RelationTree[1];");
    ...
    public static final NativeFunctionDefinition RELATION_TREE_AS_STRING__1 = signature("native function meta::pure::lineage::scanRelations::relationTreeAsString(t:meta::pure::lineage::scanRelations::RelationTree[1]):meta::pure::metamodel::type::String[1];");
    public static final NativeFunctionDefinition RELATION_TREE_AS_STRING__2 = signature("native function meta::pure::lineage::scanRelations::relationTreeAsString(t:meta::pure::lineage::scanRelations::RelationTree[1], withJoin:meta::pure::metamodel::type::Boolean[1]):meta::pure::metamodel::type::String[1];");
