...
public final class Pure {
    ...
    public static final ClassDefinition PROPERTY_METACLASS = nativeClass("native Class meta::pure::metamodel::function::property::Property<U,V|m> extends meta::pure::metamodel::function::property::AbstractProperty<{U[1]->V[m]}>, meta::pure::metamodel::PackageableElement { name: meta::pure::metamodel::type::String[1]; }");
    ...
    public static final NativeFunctionDefinition PATH_TO_ELEMENT__1 = signature("native function meta::pure::functions::meta::pathToElement(path:meta::pure::metamodel::type::String[1]):meta::pure::metamodel::PackageableElement[1];");
    ...
    public static final NativeFunctionDefinition PATH_TO_ELEMENT__2 = signature("native function meta::pure::functions::meta::pathToElement(path:meta::pure::metamodel::type::String[1], separator:meta::pure::metamodel::type::String[1]):meta::pure::metamodel::PackageableElement[1];");
    public static final NativeFunctionDefinition LENIENT_PATH_TO_ELEMENT__2 = signature("native function meta::pure::functions::meta::lenientPathToElement(path:meta::pure::metamodel::type::String[1], separator:meta::pure::metamodel::type::String[1]):meta::pure::metamodel::PackageableElement[0..1];");
    public static final NativeFunctionDefinition ELEMENT_PATH__1 = signature("native function meta::pure::functions::meta::elementPath(element:meta::pure::metamodel::PackageableElement[1]):meta::pure::metamodel::PackageableElement[1..*];");
    public static final NativeFunctionDefinition SUB_TYPE_OF__2 = signature("native function meta::pure::functions::meta::subTypeOf(subType:meta::pure::metamodel::type::Type[1], superType:meta::pure::metamodel::type::Type[1]):meta::pure::metamodel::type::Boolean[1];");
    public static final NativeFunctionDefinition GENERALIZATIONS__1 = signature("native function meta::pure::functions::meta::generalizations(class:meta::pure::metamodel::type::Type[1]):meta::pure::metamodel::type::Type[1..*];");
    public static final NativeFunctionDefinition GENERIC_TYPE_CLASS__1 = signature("native function meta::pure::functions::meta::genericTypeClass(g:meta::pure::metamodel::type::generics::GenericType[1]):meta::pure::metamodel::type::Class<meta::pure::metamodel::type::Any>[1];");
    public static final NativeFunctionDefinition SOURCE_INFORMATION__1 = signature("native function meta::pure::functions::meta::sourceInformation(node:meta::pure::metamodel::type::Any[1]):meta::pure::functions::meta::SourceInformation[0..1];");
    public static final NativeFunctionDefinition CAN_REACTIVATE_DYNAMICALLY__1 = signature("native function meta::pure::functions::meta::canReactivateDynamically(vs:meta::pure::metamodel::valuespecification::ValueSpecification[1]):meta::pure::metamodel::type::Boolean[1];");
    public static final NativeFunctionDefinition OPEN_VARIABLE_VALUES__1 = signature("native function meta::pure::functions::meta::openVariableValues(f:meta::pure::metamodel::function::Function<meta::pure::metamodel::type::Any>[1]):meta::pure::functions::collection::Map<meta::pure::metamodel::type::String,meta::pure::functions::collection::List<meta::pure::metamodel::type::Any>>[1];");
    public static final NativeFunctionDefinition EVALUATE__2 = signature("native function meta::pure::functions::lang::evaluate(func:meta::pure::metamodel::function::Function<meta::pure::metamodel::type::Any>[1], params:meta::pure::functions::collection::List<meta::pure::metamodel::type::Any>[*]):meta::pure::metamodel::type::Any[*];");
    ...
    public static final NativeFunctionDefinition LAST_INDEX_OF__3 = signature("native function meta::pure::functions::string::lastIndexOf(str:meta::pure::metamodel::type::String[1], toFind:meta::pure::metamodel::type::String[1], fromIndex:meta::pure::metamodel::type::Integer[1]):meta::pure::metamodel::type::Integer[1];");
    public static final NativeFunctionDefinition STRING_TO_TDS__1 = signature("native function meta::pure::metamodel::relation::stringToTDS(s:meta::pure::metamodel::type::String[1]):meta::pure::metamodel::relation::TDS<meta::pure::metamodel::type::Any>[1];");
    ...
    public static final NativeFunctionDefinition MINUS__INTEGER_MANY = signature("native function meta::pure::functions::math::minus(integers:meta::pure::metamodel::type::Integer[*]):meta::pure::metamodel::type::Integer[1];");
    public static final NativeFunctionDefinition PLUS__INTEGER_MANY = signature("native function meta::pure::functions::math::plus(integers:meta::pure::metamodel::type::Integer[*]):meta::pure::metamodel::type::Integer[1];");
    public static final NativeFunctionDefinition TIMES__INTEGER_MANY = signature("native function meta::pure::functions::math::times(integers:meta::pure::metamodel::type::Integer[*]):meta::pure::metamodel::type::Integer[1];");
    ...
    public static final NativeFunctionDefinition LOAD_VALUES_TO_DB_TABLE__MANY = signature("native function meta::relational::metamodel::execute::loadValuesToDbTable(tableData:meta::pure::functions::collection::List<meta::pure::functions::collection::List<meta::pure::metamodel::type::Any>>[*], table:meta::relational::metamodel::relation::Table[1], databaseConnection:meta::external::store::relational::runtime::DatabaseConnection[1]):meta::pure::metamodel::type::Nil[0];");
    public static final NativeFunctionDefinition LOAD_VALUES_TO_DB_TABLE__ONE = signature("native function meta::relational::metamodel::execute::loadValuesToDbTable(tableData:meta::pure::functions::collection::List<meta::pure::functions::collection::List<meta::pure::metamodel::type::Any>>[1], table:meta::relational::metamodel::relation::Table[1], databaseConnection:meta::external::store::relational::runtime::DatabaseConnection[1]):meta::pure::metamodel::type::Nil[0];");
