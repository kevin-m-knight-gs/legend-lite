...
public final class Pure {
    ...
    // the temp-table pair (execute.pure): platform-owned since block-compiler stage 4 (2026-09-22) — the
    // DDL is the dialect's own CreateTable / DropTable (temporary), the engine's string-builder argument is not called
    public static final NativeFunctionDefinition CREATE_TEMP_TABLE__STRING_1__COLUMN_MANY__FUNCTION_1__CONN_1 = signature("native function meta::relational::metamodel::execute::createTempTable(tableName:meta::pure::metamodel::type::String[1], cols:meta::relational::metamodel::Column[*], sql:meta::pure::metamodel::function::Function<{meta::pure::metamodel::type::String[1],meta::relational::metamodel::Column[*],meta::relational::runtime::DatabaseType[1]->meta::pure::metamodel::type::String[1]}>[1], databaseConnection:meta::external::store::relational::runtime::DatabaseConnection[1]):meta::pure::metamodel::type::Nil[0];");
    public static final NativeFunctionDefinition CREATE_TEMP_TABLE__STRING_1__COLUMN_MANY__FUNCTION_1__BOOLEAN_1__CONN_1 = signature("native function meta::relational::metamodel::execute::createTempTable(tableName:meta::pure::metamodel::type::String[1], cols:meta::relational::metamodel::Column[*], sql:meta::pure::metamodel::function::Function<{meta::pure::metamodel::type::String[1],meta::relational::metamodel::Column[*],meta::relational::runtime::DatabaseType[1]->meta::pure::metamodel::type::String[1]}>[1], relyOnFinallyForCleanup:meta::pure::metamodel::type::Boolean[1], databaseConnection:meta::external::store::relational::runtime::DatabaseConnection[1]):meta::pure::metamodel::type::Nil[0];");
    public static final NativeFunctionDefinition DROP_TEMP_TABLE__STRING_1__CONN_1 = signature("native function meta::relational::metamodel::execute::dropTempTable(tableName:meta::pure::metamodel::type::String[1], databaseConnection:meta::external::store::relational::runtime::DatabaseConnection[1]):meta::pure::metamodel::type::Nil[0];");
